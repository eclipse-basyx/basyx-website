...
<!--<div style="padding-left:210px;margin-bottom:25px">
  <img src="images/ecosystem_new.png"/> 
</div>-->
...
<ul class="custom_posts" id="posts">
  ...
  <li class="custom_post_item">
    <div class="image img-center" style="height:80px;">
      <a href="#">
          <img src="images/fortiss_logo.png" class="img-responsive" alt="">
      </a>
    </div>
    <div class="excerpt">
        <p class="pale"><b>Services:</b> <br/>
...
<ul class="custom_posts" id="posts">
  ...
  <li class="custom_post_item">
    <div class="image img-center" style="height:80px;" >
      <a href="#">
          <img src="images/Bosch_Rexroth_logo.png" class="img-responsive" alt="">
      </a>
    </div>
    <div class="excerpt">
      <p class="pale"><b>Services:</b> <br/>
...
<ul class="custom_posts" id="posts">
  <li class="custom_post_item">
    <div class="image img-center" style="height:80px; display:flex; justify-content: center;">
      <a href="#">
          <img src="images/ZF_Friedrichshafen_logo_new.png" class="img-responsive" alt="">
      </a>
    </div>
    <div class="excerpt">
        <p class="pale"><b>Services:</b> <br/>
...
<ul class="custom_posts" id="posts">
  ...
  <li class="custom_post_item">
    ...
    <div class="excerpt">
      ...
      <p class="pale"><b>Feel free to contact us:</b><br/><a>xxxxxxxxxxxxxx</a></p>
    </div>
  </li> 
  -->
</ul>
...
<ul class="custom_posts" id="posts">
  ...
  <li class="custom_post_item">
      <div class="image img-center" style="height:80px;">
        <a href="#">
            <img src="images/Logo_MMC.png" class="img-responsive" alt="">
        </a>
      </div>
      <div class="excerpt">
        <p class="pale"><b>Services:</b> <br/>
            -	Industrie 4.0-Readiness-Assesment<br/>
            -	Creation of Industrie 4.0 implementation strategies based on Basyx<br/>
            -	Realization of specialized AAS solutions
        </p>
      </div>
      <div class="excerpt">
          <p class="pale"><b>Feel free to contact us:</b><br/><a>info@twinedge.de</a></p>
      </div>
  </li>
</ul>
...
<ul class="custom_posts" id="posts">
  <li class="custom_post_item">
    ...
    <div class="excerpt">
      <p class="pale"><b>Solution:</b> <br/>
          - <a href="https://twinedge.de/" target="_blank" class="external">TwinEdge, the AAS-Enabled IIoT Edge Gateway</a><br/>
          - Retrofitting of digital twins for existing machines
      </p>
      <p class="pale"><b>Feel free to contact us:</b><br/><a>info@twinedge.de</a></p>
    </div>
  </li> 
